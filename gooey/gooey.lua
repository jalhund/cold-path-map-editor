...
function M.button(node_id, action_id, action, fn, refresh_fn, dynamic_node)
	local b = button(node_id, action_id, action, fn, refresh_fn, dynamic_node)
...
function M.dynamic_list(list_id, stencil_id, item_id, data, action_id, action, config, fn, refresh_fn, max_count_size)
	local l = list.dynamic(list_id, stencil_id, item_id, data, action_id, action, config, fn, refresh_fn, max_count_size)
	if current_group then
		current_group.components[#current_group.components + 1] = l
	end
	return l
